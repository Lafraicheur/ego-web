  ...
  howItWorks: {
    steps: [
      ...
      },
      {
        number: "02",
        title: "Trouvez-vous",
        body: "Le conducteur voit les clients à proximité. Le client voit les taxis disponibles autour de lui.",
      },
      {
        number: "03",
        title: "Négociez le prix",
        body: "Le conducteur et le client se mettent d'accord sur le prix face à face. Pas d'imposition, c'est vous qui décidez.",
      },
      {
        number: "04",
        title: "En route !",
        body: "Le trajet commence. Le client partage sa course avec ses proches, le conducteur enregistre la course.",
      },
    ],
  },

  download: {
    heading: "Rejoignez e-Go dès aujourd'hui",
    body: "Conducteur ou passager, téléchargez l'app faite pour vous et transformez chaque trajet à Abidjan.",
  },
